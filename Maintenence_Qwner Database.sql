...
values
    ...
    -- a.Write a query to  update  Ownername,mobile and email of owner of flat B111 [1]
    update owners as o
    set o.OwnerName="Abhi" ,o.mobile="6261904221",o.email="raia7130@gmail.com"
    where o.oid=(select oid from flats where flatNo="B111");
